...
const AddScheduleDialog: VFC<Props> = React.memo<Props>(
  ({ open, handleClose, addSchedule, tagBoxes }) => {
    ...
    }, [addSchedule, handleClose, inputValues, inputHandlers]);
